...
const en: Dictionary = {
	...
	'panel.copyHint': 'Long-press the coordinates to copy them.',
	'panel.mapsApp': 'Maps app',

	// Panel: messages
	'panel.swapped': 'Swapped - press Save to keep it.',
	'panel.picked': 'Position picked - press Save to keep it.',
	'panel.copied': 'Copied: {text}',
	'panel.copyFailed': 'Could not copy ({reason}). Select the text by hand instead.',
	...
	'message.insertedMap': 'Map inserted at the cursor.',
	'message.mapNeedsMarkdown': 'A map block can only be inserted in the Markdown editor - the rich text editor would escape it.',
	'message.placeMissing': ' The place name could not be fetched ({reason}), so {place} stayed empty.',
	...
	'gpx.altitude': '{metres} m above sea level',
...
const de: Dictionary = {
	...
	'panel.insertMap': 'Als Karte einfügen',
	...
	'panel.openStreetMap': 'OpenStreetMap',
	'panel.copyHint': 'Koordinaten lange drücken zum Kopieren.',
	...
	'panel.copied': 'Kopiert: {text}',
	'panel.copyFailed': 'Kopieren nicht möglich ({reason}). Dann den Text von Hand markieren.',
	...
	'message.insertedMap': 'Karte an der Cursorposition eingefügt.',
	'message.mapNeedsMarkdown': 'Ein Kartenblock lässt sich nur im Markdown-Editor einfügen - der Rich-Text-Editor würde ihn maskieren.',
	'message.placeMissing': ' Der Ortsname war nicht abrufbar ({reason}), {place} blieb deshalb leer.',
